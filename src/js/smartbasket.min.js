        ...
        userForm: function() {
            ...
            if (c.append(p), a.agreement.isRequired) {
                ...
                r = a.agreement.isLink ? t("<a>").attr({
                    ...
                    class: "smart-basket__link-agreement"
                }), s.is(":checked") ? r.text("Доставка") : r.text("Самовывоз"), e.click(function() {
                    let finPrice = $("input[name='finalPrice']").val().replace(/₽/g, "");
                    let del = 500;
                    let metka = $("input[name='2-2pz[productId]']").val();
                    if (s.is(":checked")) {
                        r.text("Самовывоз");
                        s.val("Самовывоз");
                        m.attr({
                        ...
                        if (finPrice < 5000 && metka !== '2-2pz') {
                            $("input[name='finalPrice']").val(+finPrice - del + ".00 ₽");
                        }
                    } else {
                        r.text("Доставка");
                        s.val("Доставка");
            ...
            r.append(n).append(o).append(c), a.agreement.isChecked && r.append(d), k.append(u).append(m), s.append(r).append(k), m.click(function(t) {
                ...
                if (a.nameIsRequired && a.telIsRequired && a.adresIsRequired) {
                    ...
                    e.sendCart()
                } else if (a.telIsRequired || a.adresIsRequired) {
                    if ("" === i.val() || !("" !== l.val() && a.telIsRequired || "" !== p.val() && a.adresIsRequired) || r(s)) return "" === l.val() && a.telIsRequired && l.parent().addClass("smart-basket__input-wrapper_error"), "" === p.val() && a.adresIsRequired && p.parent().addClass("smart-basket__input-wrapper_error"), "" === i.val() && i.parent().addClass("smart-basket__input-wrapper_error"), !1;
                    e.sendCart()
                }
            });
            let b = a => {
            ...
            return b(i), a.telIsRequired && b(l), a.adresIsRequired && b(p), s
        },
