...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if (isset($_POST['userAdres']) ) {
			if(empty($_POST['userAdres'])) {
				echo 'notAdres';
			} else {
				$email = "<b>Адрес: </b>" . strip_tags($_POST['userAdres']) . "<br>";
			}
		}
        ...
        if (isset($_POST['agreement']) ) {
            ...
            if(empty($_POST['agreement'])) {
                $agreement = "<b>Условия заказа: </b> Самовывоз <br>";
            } else {
                $agreement = "<b>Условия заказа: </b>" . strip_tags($_POST['agreement']) . "<br>";
            }
        } else {
        	$agreement = "<b>Условия заказа: </b> Самовывоз <br>";
        }
